...
export default function Home() {
  return (
    <div className="min-h-screen bg-gray-950 text-gray-100 font-sans selection:bg-purple-500 selection:text-white scroll-smooth">
      ...
      {/* Hero Section (건축물 적용 렌더링 이미지 배경) */}
      ...
      {/* Product Lineup Section (제품별 개별 이미지 적용) */}
      <section id="products" className="px-6 py-24 bg-gray-900">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">ARCHI-VOLT Product Lineup</h2>
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            ...
            <div className="bg-gray-950 rounded-3xl border border-gray-800 hover:border-blue-500 transition duration-300 overflow-hidden group flex flex-col">
              ...
              <div className="p-8 flex-1">
                <h3 className="text-2xl font-bold text-gray-100 mb-1">BSU-500A</h3>
                <p className="text-blue-400 text-sm font-semibold mb-4">A-Series : 통합 플랫폼의 시작</p>
            ...
            {/* BSU-500B */}
            <div className="bg-gray-950 rounded-3xl border border-gray-800 hover:border-emerald-500 transition duration-300 overflow-hidden group flex flex-col">
              <div className="h-48 overflow-hidden relative">
                <img 
              ...
              <div className="p-8 flex-1 relative">
                <h3 className="text-2xl font-bold text-gray-100 mb-1">BSU-500B</h3>
                <p className="text-emerald-400 text-sm font-semibold mb-4">B-Series : 트리플 양이온 에디션</p>
                <p className="text-gray-400 text-sm mb-6 leading-relaxed">
                  Drop-in 업그레이드를 통해 단일 조성의 열화 한계를 극복하고 발전량과 신뢰성을 극대화.
                </p>
                <ul className="space-y-3 mt-auto text-sm text-gray-300">
            ...
            {/* BSU-600A (New Flagship) */}
            <div className="bg-gradient-to-b from-gray-900 to-purple-950/50 rounded-3xl border border-purple-500/50 shadow-[0_0_30px_rgba(168,85,247,0.15)] group transform lg:-translate-y-4 overflow-hidden flex flex-col relative">
              <div className="absolute top-0 right-0 bg-purple-500 text-white text-xs font-black px-4 py-1.5 rounded-bl-2xl z-20 shadow-lg">
                AUTONOMOUS FLAGSHIP
              </div>
              <div className="h-52 overflow-hidden relative">
                <img 
                  ...
                  alt="BSU-600A 모듈" 
                  className="w-full h-full object-cover transform group-hover:scale-110 transition duration-700 hue-rotate-[45deg]"
                />
